...
exports.TODO_EXTRACT_PROMPT = exports.CHAT_CONTEXT_PROMPT = exports.LOG_PROMPT = exports.A11Y_SYSTEM_PROMPT = exports.MODEL_SELECTOR = exports.CodeA11y_PARTICIPANT_ID = void 0;
exports.CodeA11y_PARTICIPANT_ID = "codea11y.CodeA11y";
// Use gpt-4o since it is fast and high quality. gpt-3.5-turbo and gpt-4 are also available.
exports.MODEL_SELECTOR = {
    vendor: "copilot",
    family: "gpt-4o",
};
exports.A11Y_SYSTEM_PROMPT = `I am unaware about accessibility and need to write code that conforms with the WCAG 2.1 level A and AA success criteria defined at https://www.w3.org/TR/WCAG21/. 
...
exports.LOG_PROMPT = `Review the accessibility checker log and provide feedback to fix errors relevant to current chat context. 
...
Just say "/n".`;
exports.CHAT_CONTEXT_PROMPT = `This is GitHub Copilot's response to a developer request for a code snippet.`;
exports.TODO_EXTRACT_PROMPT = `Is there a concrete step that the developer needs to complete to comply with accessibility standards after receiving this response?
