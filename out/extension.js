...
async function getAccessibilityLogContext() {
    try {
        ...
        try {
            ...
            const response = await axios_1.default.get(websiteUrl, {
                timeout: timeout,
                headers: {
                    "User-Agent": "Mozilla/5.0 (compatible; CodeA11y-Accessibility-Checker/1.0)",
                },
            });
            ...
            console.log(`DOM created successfully. Document has ${document.querySelectorAll("*").length} elements`);
            ...
            try {
                ...
                try {
                    ...
                    const errorMessage = contextError instanceof Error
                        ...
                        : "Unknown error";
                    console.log("Direct context method failed, trying alternative approach:", errorMessage);
                    ...
                    try {
                        ...
                        const globalErrorMessage = globalError instanceof Error
                            ? globalError.message
                            : "Unknown error";
                        console.log("Global method failed, trying root element approach:", globalErrorMessage);
...
`;
                ...
                .join("");
            const logContent = logHeader + (violations || "No accessibility violations found");
            ...
            vscode.window.showInformationMessage("📝 Accessibility log updated: accessibility.log");
            return logContent;
        }
        catch (error) {
            ...
            try {
                ...
                vscode.window.showWarningMessage("⚠️ Accessibility check error logged: accessibility-error.log");
            }
            catch (writeError) {
...
function activate(context) {
    ...
    const handler = async (request, context, stream, token) => {
        try {
            ...
            if (model) {
                ...
                stream.markdown("🔍 *Analyzing your website for accessibility issues...*\n\n");
    ...
    context.subscriptions.push(CodeA11y.onDidReceiveFeedback((feedback) => {
